...
class NoteSerializerTest(TestCase):
    ...
    def test_success_create(self):
        ...
        instantiated_notes_class.create = MagicMock(
            return_value=serializer_object)
        self.assertEqual(instantiated_notes_class.create(serializer_object),
                         serializer_object)
    ...
    def test_failed_create(self):
        ...
        self.assertRaises(ValidationError, instantiated_notes_class.create,
                          serializer_object_unformatted)
...
class NotesViewSetTest(TestCase):
    ...
    def test_queryset_parameters(self):
        ...
        instantiated_notes_views_class.get_queryset = MagicMock(
            return_value=request_object)
        self.assertEqual(
            instantiated_notes_views_class.get_queryset(request_object),
            request_object)
